...
class Habit:
    ...
    def __repr__(self):
        return f"Habit(id={self.id}, name={self.name}, frequency={self.frequency}, description={self.description}, created_at={self.created_at}, streak={self.streak}, complete_habit={self.complete_habit})"
